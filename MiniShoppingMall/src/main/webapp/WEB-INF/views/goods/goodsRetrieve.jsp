...
<form name="goodsRetrieveForm" method="get" id="goodsRetrieveForm" action="#">
		...
		<tr>
			<td>
				<table align="center" width="710" cellspacing="0" cellpadding="0" border="0" style='margin-left: 30px'>
					...
					<tr>
						<td rowspan="7"><img src="images/items/${goodsRetrieve.gImage}.gif" border="0" align="middle" width="300"></td>
						<td class="td_title">제품코드</td>
						<td class="td_default" colspan="2" style='padding-left: 30px'><b>${goodsRetrieve.gCode}</b></td>
					</tr>
					<tr>
						<td class="td_title">상품명</td>
						<td class="td_default" colspan="2" style='padding-left: 30px'><b>${goodsRetrieve.gName}</b></td>
					</tr>
					<tr>
						<td class="td_title">가격</td>
						<td class="td_red" colspan="2" style="padding-left: 30px; color: red;"><b>${goodsRetrieve.gPrice}&nbsp;원</b></td>
					</tr>
					<tr>
						<td class="td_title">배송비</td>
						<td colspan="2">
							<font color="#2e56a9" size="2" style="padding-left: 30px"><b> 무료배송 </b></font>
							<font size="2">도서 산간 지역 별도 배송비 추가</font>
						</td>
					</tr>
					<tr>
						...
						<td colspan="2" style="padding-left: 30px">
							<select class="select_change" size="1" name="gSize" id="gSize">
								<option selected="selected" value="사이즈선택">사이즈선택</option>
					...
					<tr>
						<td colspan="2" style="padding-left: 30px">
							<select class="select_change" size="1" name="gColor" id="gColor">
								<option selected="selected" value="색상선택">색상선택</option>
